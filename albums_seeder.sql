...
VALUES ('Michael Jackson', 'Thriller', 1982, 70, 'Pop, post-disco, funk, rock'),
       ...
       ('Whitney Houston and others', 'The Bodygaurd', 1992, 45, 'R&B, soul, pop, soundtrack'),
       ('Pink Floyd', 'The Dark Side of the Moon', 1973, 45, 'Progressive rock'),
       ('Eagles', 'Their Greatest Hits', 1976, 44, 'Country rock, soft rock, folk rock'),
       ...
       ('Bee Gees and others', 'Saturday Night Fever', 1977, 40, 'Disco'),
       ...
       ('Alanis Morissette', 'Jagged Little Pill', 1995, 32, 'Alternative rock'),
       ...
       ('Bob Marley & The Wailers', 'Legend, The Best of Bob Marley and the Wailers', 1984, 30, 'Reggae'),
